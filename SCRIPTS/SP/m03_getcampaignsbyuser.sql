...
BEGIN
RETURN QUERY
SELECT DISTINCT  ca.cam_id, ca.cam_name, ca.cam_description, ca.cam_start_date, ca.cam_end_date, ca.cam_status, ca.cam_company_id from campaign ca INNER JOIN company co ON ca.cam_company_id = co.com_id 

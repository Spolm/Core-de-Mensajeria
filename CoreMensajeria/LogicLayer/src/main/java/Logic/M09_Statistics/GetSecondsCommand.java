...
public class GetSecondsCommand extends Command<ArrayList<Integer>> {
    ...
    public void execute() throws Exception {
        ...
        log.debug("Entrando a el metodo execute() de GetSecondsCommand" );
        //endregion
        ...
        //endregion
        //region Instrumentation Debug
        log.debug("Saliendo de el metodo execute() de GetSecondsCommand" );
        //endregion
    }
    ...
    public ArrayList<Integer> Return() {
        //region Instrumentation Debug
        log.debug("Entrando a el metodo return() de GetSecondsCommand" );
        //endregion
        //region Instrumentation Info
        log.info("Se ejecuto el metodo Return() exitosamente");
        //endregion
        //region Instrumentation Debug
        log.debug("Saliendo de el metodo Return() de GetSecondsCommand" );
        //endregion
        return seconds;
    }
}

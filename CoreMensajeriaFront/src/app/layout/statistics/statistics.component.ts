...
if (this.opcionDateSleccionado != null){ 	  
    ...
    this.paramType="paramType="+this.verSeleccion;
     ...
     this.Servicio.getStatisticsData4(this.paramDate + "&" + this.paramType).subscribe(data => { 
     console.log(data);
          ...
          console.log("Data3:", this.json2) 
            ...
            this.Servicio.getStatisticsData4(this.paramDate + "&" + this.paramType).subscribe(data => {
              ...
              console.log("DataLine:", this.json2) 
                ...
                this.Servicio.getStatisticsData5(this.paramDate + "&" + this.paramType).subscribe(data => {
                  this.json2 = data
                  this.chart(this.json2) 
                  console.log("DataPie:", this.json2) 
                    })
                    
            this.Servicio.getStatisticsData6(this.paramDate + "&" + this.paramType).subscribe(data => {
              this.json2 = data
              this.chart3(this.json2) 
...
console.log("ALERTA");
  ...
  chart3(datos){
     ...
     const  layout = {width: 500, height: 300, title: 'Cantidad de mensajes enviados por ' + this.verSeleccion}
